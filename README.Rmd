...
The goal of fmri is to perform an fMRI analysis as described in
             Tabelow et al. (2006) <https://doi.org/10.1016/j.neuroimage.2006.06.029>,
             Polzehl et al. (2010) <https://doi.org/10.1016/j.neuroimage.2010.04.241>,
             Tabelow and Polzehl (2011) <https://doi.org/10.18637/jss.v044.i11>.

## Installation

You can install the released version of fmri from [CRAN](https://CRAN.R-project.org) with:
...
```{r create_stim_model, eval = FALSE}
